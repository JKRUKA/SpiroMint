          ...
          value: function calculateScore(clusters) {
            ...
            for (var _i2 = 0; _i2 < clCount; _i2++) {
              for (var j = _i2 + 1; j < clCount; j++) {
                ...
                if (d < 2 || d > 8) continue;
                if (isFraction) err = Math.abs(clIntervals[_i2] * d - clIntervals[j]);
                else err = Math.abs(clIntervals[_i2] - clIntervals[j] * d);
  ...
  "node_modules/music-tempo/dist/node/MusicTempo.js"(exports, module) {
    (function(global, factory) {
      ...
      var MusicTempo = (
         ...
         */
        function MusicTempo2(audioData) {
          var _this = this;
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          _classCallCheck(this, MusicTempo2);
      ...
      exports2.default = MusicTempo;
      module2.exports = exports2["default"];
    });
  }
});
export default require_MusicTempo();
//# sourceMappingURL=music-tempo.js.map
